...
const CTA = () => {
  return (
    <section className="w-full  sm:px-5 lg:px-20 pt-20">
      <div className=" w-full max-w-[1440px] mx-auto sm:pl-10 pb-10 pt-10  flex  items-center justify-between border-3  border-[#4A4A4A08] rounded-4xl relative overflow-hidden">
        <div className="w-full md:w-3/5 grid place-items-center md:place-items-start ">
          <div className="  text-[#2E2E2E] text-[65px] 2xl:text-[148px]  tracking-tighter font-bold">
            <div className="flex gap-4 md:gap-8 items-center ">
              <h1 className="">Make</h1>
              <div className=" w-42 h-14 xl:w-52 xl:h-20  mt-4 md:mt-10 relative">
            ...
            <div className="-mt-10 md:-mt-8 2xl:-mt-24  flex gap-4 md:gap-8 items-center mb-28 ">
              ...
              <div className=" hidden 2xl:block size-8 mt-20 bg-[#2E2E2E] -ml-6  rounded-full"></div>
            </div>
          </div> 

          <div className="flex flex-col gap-6 ">
            <p className="text-[#898D91E6] xl:text-2xl w-[300px] xl:w-[400px] mx-auto t 2xl:leading-relaxed">
